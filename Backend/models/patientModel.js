...
import crypto from "crypto"; // we will use it to generate a random hashed token
...
const patientSchema = new mongoose.Schema(
  {
    ...
    medicalHistory: {
      type: [String], // Array of strings for storing medical history
      required: false,
    },
    emergencyContact: {
      name: {
...
patientSchema.pre("save", async function (next) {
  ...
  // Hash the password before saving & it will run only when password is modified
